...
define mv-modules
    ...
    if [ "$$mdpath" != "" ];then\
        ...
        for i in $$ko; do $(ARM_EABI_TOOLCHAIN)/$(ARM_TOOLCHAIN_PREFIX)strip --strip-unneeded $$i;\
...
ifeq ($(TARGET_ARCH),arm)
    ...
    ifneq ($(TARGET_KERNEL_CUSTOM_TOOLCHAIN),)
        ...
        ARM_CROSS_COMPILE:=CROSS_COMPILE="$(ccache) $(ARM_EABI_TOOLCHAIN)/$(ARM_TOOLCHAIN_PREFIX)"
    endif
    ccache = 
endif
